...
class MapService {
    ...
    load() {
        ...
        // js에서는 함수를 등록해줄때 this를 항상 써야 한다.
    ...
    addSearchInputEvent() {
        ...
        searchInput.onclick = () => {
            ...
            // .이 붙을때는 선택자 일때만 붙는다(querySelector)
    ...
    addAsideToggleButtonEvent() {
        ...
        toggleButton.onclick = () => {
            ...
            if (aside.classList.contains("invisible-aside")) { // contains : 포함하고있을때
...
// window 객체에 onload가 일어나면 화살표함수를 실행해라
window.onload = () => {
